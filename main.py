...
async def send_welcome(message: types.Message):
    welcome_text = (
        ...
        "/dev [повідомлення] - Надіслати повідомлення у DEV-чати.\n"
        "/prod [повідомлення] - Надіслати повідомлення у PROD-чати.\n"
        "/all [повідомлення] - Надіслати повідомлення у всі чати.\n"
        "/tickets - Показати всі відкриті тікети.\n"
        "/history - Показати історію закритих тікетів.\n"
        "/id - Отримати ID поточного чату.\n\n"
